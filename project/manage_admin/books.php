...
$x=0;
echo "<div class='row' id='asdfg'style='overflow-x:hidden;'>";
    while($row = $result->fetch_assoc()) {


        if($x==0){         

            echo "<form action='bookzoom.php' method='post'><div class='col-xs-4 col-sm-4' ><div >";    
    echo "<a name='".$row["AUTHOR_NAME"]."' ><tr><img src='http://localhost:7777/project/duplicate/biographies_img/".$row["IMAGE"]."'style='display: block;
    margin-left: auto;
    margin-right: auto;'><input type='text' name='firstname' value='".$row["AUTHOR_NAME"]."'style='visibility: hidden;'><br><input type='text' name='lastname' value='".$row["TITLE"]."'style='visibility: hidden;'>";

        echo "<input type='submit' value='".$row["AUTHOR_NAME"]."'style='padding-left: 35%;border: none;
background: none;'>";
                       echo "<input type='submit' value='".$row["TITLE"]."'style='padding-left: 35%;border: none;
background: none;text-align:center'>";
    ...
    echo "<a  name='".$row["AUTHOR_NAME"]."'><tr><img src='http://localhost:7777/project/duplicate/biographies_img/".$row["IMAGE"]."'style='display: block;
    margin-left: auto;
    margin-right: auto;'><input type='text' name='firstname' value='".$row["AUTHOR_NAME"]."'style='visibility: hidden;'><input type='text' name='lastname' value='".$row["TITLE"]."' style='visibility: hidden;'>";
...
background: none;text-align:center'>";
    ...
    echo "<a  name='".$row["AUTHOR_NAME"]."'><tr><img src='http://localhost:7777/project/duplicate/biographies_img/".$row["IMAGE"]."'style='display: block;
    margin-left: auto;
    margin-right: auto;'><input type='text' name='firstname' value='".$row["AUTHOR_NAME"]."'style='visibility: hidden;'>
    
    <input type='text' name='lastname' value='".$row["TITLE"]."'style='visibility: hidden;'>";
        echo "<input type='submit' value='".$row["AUTHOR_NAME"]."'style='padding-left: 35%;border: none;
background: none;'>";
                       echo "<input type='submit' value='".$row["TITLE"]."'style='padding-left: 35%;border: none;
background: none;text-align:center'>";
