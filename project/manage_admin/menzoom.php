...
$sql = "SELECT * FROM clothing where SUB_CATEGORY_ID='m2cl1' and brand='".$y."' and color='".$x."'";
...
<div class="container">
	<div class="row" style="background-color:white" >
		...
		<img src='http://localhost:7777/project/duplicate/clothes/".$folder."/".$foldersmall."' width='175' height='320' alt='Daisy on the Ohoopee'id='imageid1' style='position:center'/>
	</span>";
    ...
    <div class="col-md-3">
      <a class="thumbnail">
            <?php
                echo"<img src='http://localhost:7777/project/duplicate/clothes/".$folder."/".$foldersmall."' alt='earing' onclick='first1s()' style='width:150px;height:100px' class='thumbnail'/>";
    ?>
   ...
   <div class="col-md-3">
      <a  class="thumbnail">
	   ...
	   <span class="glyphicon glyphicon-circle-arrow-right" style="align:center;position:center" ></span></div>
			...
			<h2 class="arc">Product's name:<?php echo $brand." ".$color; ?></h2>
			<hr>
