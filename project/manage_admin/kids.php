...
<div class="row">
    ...
    <input type="checkbox" /> Buy It Now <br />
        ...
        <form action="">
        <div style="height: 100px;width:200px; overflow-y: scroll;">
    <input type="checkbox"value='samsung' id='age' onclick='ajaxFunction()'/> 0 - 3 Months <br />
    <input type="checkbox"/> 3 - 6 Months <br />
    <input type="checkbox" /> 1 - 2 Years <br />
    <input type="checkbox" />2 - 3 Years<br />
    <input type="checkbox" /> 3 - 4 Years <br />
    <input type="checkbox" /> 4 - 5 Years  <br />
    <input type="checkbox" /> 5 - 6 years <br />
                <input type="checkbox" /> 6 - 7 Years <br />
    <input type="checkbox" /> 7 - 8 Years  <br />
    <input type="checkbox" /> 8 - 9 years <br />
                            <input type="checkbox" /> 9 - 10 Years <br />
    <input type="checkbox" /> 10 - 11 Years  <br />
    <input type="checkbox" /> 8 - 9 years <br />
...
echo "<div class='row' id='asdfg'>";
    ...
    echo "<a ><tr><img src='http://localhost:7777/project/duplicate/".$row["folder"]."/".$row["IMAGE"]."'style='display: block;
    margin-left: auto;
    margin-right: auto;'><input type='text' name='firstname' value='".$row["BRAND"]."'style='visibility: hidden;'><input type='text' name='lastname' value='".$row["COLOR"]."'style='visibility: hidden;'>";
          echo "<input type='submit' value='".$row["BRAND"]." ".$row["COLOR"]."'style='padding-left: 35%;border: none;
background: none;'>";
        ...
        if($x==1){
            ...
            echo "<form action='mobilezoom.php' method='post'><div class='col-xs-4 col-sm-4' ><div>";    
    echo "<a  name='".$row["BRAND"]."'><tr><img src='http://localhost:7777/project/duplicate/".$row["folder"]."/".$row["IMAGE"]."'style='display: block;
    margin-left: auto;
    margin-right: auto;'><input type='text' name='firstname' value='".$row["BRAND"]."'style='visibility: hidden;'><input type='text' name='lastname' value='".$row["COLOR"]."' style='visibility: hidden;'>";
...
background: none;'>";
    ...
    margin-left: auto;
    margin-right: auto;'><input type='text' name='firstname' value='".$row["BRAND"]."'style='visibility: hidden;'><input type='text' name='lastname' value='".$row["COLOR"]."'style='visibility: hidden;'>";
         echo "<input type='submit' value='".$row["BRAND"]." ".$row["COLOR"]."'style='padding-left: 35%;
border: none;
background: none;'>";
          echo "<p style='text-align:center;'>Rs.".$row["PRICE"]."</p>";
                   echo"</div></div></form>";
