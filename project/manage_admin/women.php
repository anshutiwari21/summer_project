...
$sql = "SELECT * FROM CLOTHING where SUB_SUB_CATEGORY_ID='w3cl1ssl4'";
...
echo "<div class='row' id='asdfg'>";
    while($row = $result->fetch_assoc()) {
        ...
        if($x==0){         
            ...
            echo "<form action='womenzoom.php' method='post'><div class='col-xs-4 col-sm-4' ><div >";    
    echo "<a ><tr><img src='http://localhost:7777/project/duplicate/salwar_suit/".$row["tiny_image_a"]."'style='display: block;
    margin-left: auto;
    margin-right: auto;'><input type='text' name='firstname' value='".$row["BRAND"]."'style='visibility: hidden;'><input type='text' name='lastname' value='".$row["COLOR"]."'style='visibility: hidden;'>";
            ...
            echo "<input type='submit' width='4' value='".$row["BRAND"]." ".$row["NAME"]."'style='padding-left: 35%;border: none;
background: none;width:100%;text-align:center;text-overflow: ellipsis;'>";
          echo "<p style='text-align:center;'>Rs.".$row["SELLING_PRICE"]."</p>";
    ...
    echo "<a ><tr><img src='http://localhost:7777/project/duplicate/salwar_suit/".$row["tiny_image_a"]."'style='display: block;
    margin-left: auto;
    margin-right: auto;'><input type='text' name='firstname' value='".$row["BRAND"]."'style='visibility: hidden;'><input type='text' 
    name='lastname' value='".$row["COLOR"]."' style='visibility: hidden;'>";
...
background: none;width:100%;text-align:center;text-overflow: ellipsis;'>";
    ...
    margin-left: auto;
    margin-right: auto;'><input type='text' name='firstname' value='".$row["BRAND"]."'style='visibility: hidden;'><input type='text' name='lastname' value='".$row["COLOR"]."'style='visibility: hidden;'>";
         echo "<input type='submit' value='".$row["BRAND"]." ".$row["NAME"]."'style='padding-left: 35%;
border: none;
background: none;text-align:center;text-overflow: ellipsis; width:100%;'>";
          echo "<p style='text-align:center;'>Rs.".$row["SELLING_PRICE"]."</p>";
