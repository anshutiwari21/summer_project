...
$sql = "SELECT * FROM books where AUTHOR_NAME='".$y."' and TITLE='".$x."'";
...
<div class="container">
	<div class="row" style="background-color:white" >
		...
		<img src='http://localhost:7777/project/duplicate/biographies_img/".$img."' width='175' height='320' alt='Daisy on the Ohoopee'id='imageid1' style='position:center'/>
	</span>";
    ?>
			<p style="height:20px">
			</p>
    ...
    <div class="col-md-3">
      <a class="thumbnail">
            <?php
                echo"<img src='http://localhost:7777/project/duplicate/biographies_img/".$img."' alt='earing' onclick='first1s()' style='width:150px;height:100px' class='thumbnail'/>";
    ?>
