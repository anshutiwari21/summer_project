...
echo "<div class='row' id='asdfg'>";
    while($row = $result->fetch_assoc()) {
        ...
        if($x==0){         
            ...
            echo "<form action='laptopzoom.php' method='post'><div class='col-xs-4 col-sm-4' ><div >";    
    echo "<a ><tr><img src='http://localhost:7777/project/duplicate/laptops/".$row["FOLDER"]."/".$row["IMAGE"].".jpeg'style='display: block;
    margin-left: auto;
