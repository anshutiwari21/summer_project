...
$sql = "SELECT * FROM clothing where SUB_CATEGORY_ID='m2cl1'";
...
echo "<div class='row' id='asdfg'>";
    while($row = $result->fetch_assoc()) {
        ...
        if($x==0){         
            ...
            echo "<form action='menzoom.php' method='post'><div class='col-xs-4 col-sm-4' ><div >";    
    echo "<a ><tr><img src='http://localhost:7777/project/duplicate/clothes/".$row["folder"]."/".$row["IMAGE"]."'style='display: block;
    margin-left: auto;
...
background: none;'>";
        ...
        if($x==1){
            ...
            echo "<form action='menzoom.php' method='post'><div class='col-xs-4 col-sm-4' ><div>";    
    echo "<a  name='".$row["BRAND"]."'><tr><img src='http://localhost:7777/project/duplicate/clothes/".$row["folder"]."/".$row["IMAGE"]."'style='display: block;
    margin-left: auto;
    margin-right: auto;'><input type='text' name='firstname' value='".$row["BRAND"]."'style='visibility: hidden;'><input type='text' name='lastname' value='".$row["COLOR"]."' style='visibility: hidden;'>";
